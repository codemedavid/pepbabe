            ...
            <div className="bg-white rounded shadow-clinical p-6 sticky top-24 border border-gray-100">
              ...
              <div className="bg-clinical-blue/30 rounded p-4 mb-6 border border-charcoal-100">
                ...
                <ul className="text-xs text-gray-600 space-y-1">
                  ...
                  <li className="flex justify-between"><span>Visayas</span> <span className="font-medium">₱150</span></li>
                  <li className="flex justify-between"><span>Mindanao</span> <span className="font-medium">₱200</span></li>
                </ul>
              </div>
